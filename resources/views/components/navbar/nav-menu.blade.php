<div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-gray-900 menu-icon-gray-500 menu-arrow-gray-500 menu-state-icon-primary menu-state-bullet-primary fw-semibold fs-6 align-items-stretch my-5 my-lg-0 px-2 px-lg-0"
    ...
    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-end"
        ...
        <span class="menu-link">
            <span class="menu-title">مسارات التعلم</span>
            <span class="menu-arrow d-lg-none"></span>
        </span>
            ...
            <div class="menu-active-bg px-4 px-lg-0">
                ...
                <div class="tab-content py-4 py-lg-8 px-lg-7">
                    @foreach ($learningPaths as $learningPath)
                        <div class="tab-pane {{ $loop->first ? 'show active' : '' }} w-lg-1000px"
                            id="kt_app_header_menu_paths_{{ $learningPath->slug }}">
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="row">
                                        @foreach ($learningPath->learningStacks->where('is_active', true) as $learningStack)
                                            <div class="col-lg-3 mb-6 mb-lg-0">
                                                <!--begin:Menu heading-->
                                                <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">{{ $learningStack->title }}
                                                </h4>
                                ...
                                <div class="col-lg-4">
                                    <img src="{{ feature_image_or_default($learningPath->image) }}"
