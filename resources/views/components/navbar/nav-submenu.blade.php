                     ...
                     <a style="direction: rtl" href="pages/social/feeds.html"
                         ...
                         <div class="symbol symbol-35px symbol-lg-40px me-3">
                             <span class="symbol-label rounded-4" style="background-color: #6441A5">
                                 <img src="{{ asset('assets') }}/media/svg/brand-logos/twitch-2.svg" class="mw-25px"
                                     alt="" />
                             </span>
                         </div>
                         <!--end::Symbol-->
                     ...
                     <a style="direction: rtl" href="pages/social/activity.html"
                         ...
                         <div class="symbol symbol-35px symbol-lg-40px me-3">
                             <span class="symbol-label rounded-4" style="background-color: #E34984">
                                 <img src="{{ asset('assets') }}/media/svg/brand-logos/dribbble-2.svg" class="mw-25px"
                                     alt="" />
                             </span>
                         </div>
                         <!--end::Symbol-->
                     ...
                     <a style="direction: rtl" href="pages/social/followers.html"
                         ...
                         <div class="symbol symbol-35px symbol-lg-40px me-3">
                             <span class="symbol-label rounded-4" style="background-color: #001935">
                                 <img src="{{ asset('assets') }}/media/svg/brand-logos/tumblr.svg" class="mw-25px"
                                     alt="" />
                             </span>
                         </div>
                         <!--end::Symbol-->
                     ...
                     <a style="direction: rtl" href="pages/social/feeds.html"
                         ...
                         <div class="symbol symbol-35px symbol-lg-40px me-3">
                             <span class="symbol-label rounded-4" style="background-color: #E60000">
                                 <img src="{{ asset('assets') }}/media/svg/brand-logos/youtube-2.svg" class="mw-25px"
                                     alt="" />
                             </span>
                         </div>
                         <!--end::Symbol-->
                     ...
                     <a style="direction: rtl" href="pages/social/settings.html"
                         ...
                         <div class="symbol symbol-35px symbol-lg-40px me-3">
                             <span class="symbol-label rounded-4" style="background-color: #0B66C3">
                                 <img src="{{ asset('assets') }}/media/svg/brand-logos/linkedin-3.svg" class="mw-25px"
                                     alt="" />
                             </span>
                         </div>
                         <!--end::Symbol-->
                     ...
                     <a style="direction: rtl" href="pages/social/followers.html"
                         ...
                         <div class="symbol symbol-35px symbol-lg-40px me-3">
                             <span class="symbol-label rounded-4" style="background-color: #cfe2ff">
                                 <img src="{{ asset('assets') }}/media/svg/brand-logos/vimeo.svg" class="mw-25px"
                                     alt="" />
                             </span>
                         </div>
                         <!--end::Symbol-->
