    ...
    <div class="accordion" id="kt_accordion_1">
        @foreach ($course->sections->sortBy('order') as $key => $section)
            <div class="accordion-item">
                <h2 class="accordion-header" id="kt_accordion_1_header_{{ $key + 1 }}">
                    <button class="accordion-button fs-4 fw-semibold" type="button" data-bs-toggle="collapse"
                        data-bs-target="#kt_accordion_1_body_{{ $key + 1 }}" aria-expanded="false"
                        aria-controls="kt_accordion_1_body_{{ $key + 1 }}">
                        {{ $section->name }}
                    </button>
                </h2>
                <div id="kt_accordion_1_body_{{ $key + 1 }}" class="accordion-collapse collapse"
                    aria-labelledby="kt_accordion_1_header_{{ $key + 1 }}" data-bs-parent="#kt_accordion_1">
                            ...
                            <div class="">
                                <div
                                    ...
                                    <i class="ki-duotone ki-notification-bing fs-2hx text-primary me-4 mb-5 mb-sm-0"><span
                                            ...
                                            class="path3"></span></i>
                                    <div class="d-flex flex-column pe-0 pe-sm-10">
                                        <h5 class="fw-semibold">لم يتم إضافة دروس لهذا القسم بعد.
                                        </h5>
                                        <a href="#"
                                            class="align-items-center text-primary opacity-75-hover fs-6 fw-semibold">إضافة
                                            دروس لهذا القسم
                                            <i class="ki-outline ki-exit-right-corner fs-4 ms-1"></i></a>
                                    </div>
                                </div>
