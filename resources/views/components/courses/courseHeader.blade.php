<div class="card border-0 mb-4" data-bs-theme="light"
    ...
    <div class="card-body">
        ...
        <div class="row align-items-center h-100">
            ...
            <div class="col-7 ps-xl-13">
                ...
                <!--end::Text-->
                <!--begin::Items-->
                <div class="d-flex align-items-center flex-wrap d-grid gap-2 mb-10 mb-xl-10">
                    <!--begin::Item-->
                ...
                <div class="d-flex align-items-center flex-wrap d-grid gap-2 mb-10 mb-xl-10">
                    <div class="lh-1">
                        ...
                        <span class="fs-6 text-white">(8,890)</span>
                    </div>
                </div>
                <!--begin::Action-->
                <div class="d-flex flex-column flex-sm-row d-grid gap-2">
                    <a href="#" class="btn btn-success flex-shrink-0 me-lg-2" data-bs-toggle="modal"
                        ...
                        Plan</a>
                    <button href="#" id="add-to-cart" onclick="addToCart('{{ $course->id }}')"
                        class="btn btn-success flex-shrink-0 me-lg-2" type="submit">Add to
                        cart</button>
                    <button href="#" id="cart-destroy" onclick="CartDestroy()"
                        class="btn btn-success flex-shrink-0 me-lg-2" type="submit">Empty Cart</button>
                    @if (is_course_author($course->creator->id) || is_admin(Auth::user()->id))
                        <a href="/admin/courses/{{ $course->id }}/edit" class="btn btn-primary flex-shrink-0"
                            style="background: rgba(255, 255, 255, 0.2)">Edit Details</a>
                    @endif
                </div>
                <!--end::Action-->
            </div>
