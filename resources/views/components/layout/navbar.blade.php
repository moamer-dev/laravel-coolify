            ...
            <div class="d-flex flex-grow-1 flex-lg-grow-0">
                ...
                <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                    ...
                    <div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                        ...
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            data-kt-menu-placement="bottom-end" data-kt-menu-offset="-200,0"
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            ...
                            <div
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link py-3"
                                        href="https://preview.keenthemes.com/metronic8/demo35/layout-builder.html"
                ...
                <div class="app-navbar-item ms-3 ms-lg-9" id="kt_header_user_menu_toggle">
                    ...
                    <div class="d-flex align-items-center" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <div class="text-end d-none d-sm-flex flex-column justify-content-center me-3">
                            ...
                            <a href="pages/user-profile/overview.html"
                                class="text-gray-800 text-hover-primary fs-7 fw-bold d-block">{{ Auth::user()->name }}</a>
                        </div>
                        <!--end:Info-->
                        <!--begin::User-->
                        <div class="cursor-pointer symbol symbol symbol-circle symbol-35px symbol-md-40px">
                            <img class="" src="{{ asset('assets') }}/media/avatars/300-2.jpg"
                                alt="user" />
                            <div
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src=">{{ Auth::user()->profile->avatar }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <a href="pages/social/feeds.html"
                            ...
                            <div class="symbol symbol-35px symbol-lg-40px me-3">
                                <span class="symbol-label rounded-4" style="background-color: #6441A5">
                                    <img src="{{ asset('assets') }}/media/svg/brand-logos/twitch-2.svg"
                                        class="mw-25px" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="pages/social/activity.html"
                            ...
                            <div class="symbol symbol-35px symbol-lg-40px me-3">
                                <span class="symbol-label rounded-4" style="background-color: #E34984">
                                    <img src="{{ asset('assets') }}/media/svg/brand-logos/dribbble-2.svg"
                                        class="mw-25px" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="pages/social/feeds.html"
                            ...
                            <div class="symbol symbol-35px symbol-lg-40px me-3">
                                <span class="symbol-label rounded-4" style="background-color: #00BF6D">
                                    <img src="{{ asset('assets') }}/media/svg/brand-logos/gab.svg" class="mw-25px"
                                        alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="pages/social/followers.html"
                            ...
                            <div class="symbol symbol-35px symbol-lg-40px me-3">
                                <span class="symbol-label rounded-4" style="background-color: #001935">
                                    <img src="{{ asset('assets') }}/media/svg/brand-logos/tumblr.svg"
                                        class="mw-25px" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="pages/social/feeds.html"
                            ...
                            <div class="symbol symbol-35px symbol-lg-40px me-3">
                                <span class="symbol-label rounded-4" style="background-color: #E60000">
                                    <img src="{{ asset('assets') }}/media/svg/brand-logos/youtube-2.svg"
                                        class="mw-25px" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="pages/social/settings.html"
                            ...
                            <div class="symbol symbol-35px symbol-lg-40px me-3">
                                <span class="symbol-label rounded-4" style="background-color: #0B66C3">
                                    <img src="{{ asset('assets') }}/media/svg/brand-logos/linkedin-3.svg"
                                        class="mw-25px" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="pages/social/feeds.html"
                            ...
                            <div class="symbol symbol-35px symbol-lg-40px me-3">
                                <span class="symbol-label rounded-4" style="background-color: #2682ff">
                                    <img src="{{ asset('assets') }}/media/svg/brand-logos/eolic-energy.svg"
                                        class="mw-25px" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="pages/social/feeds.html"
                            ...
                            <div class="symbol symbol-35px symbol-lg-40px me-3">
                                <span class="symbol-label rounded-4" style="background-color: #f1aeb5">
                                    <img src="{{ asset('assets') }}/media/svg/brand-logos/foursquare.svg"
                                        class="mw-25px" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                            <!--begin::Info-->
                            <div class="d-flex justify-content-center flex-column">
                                <span class="fw-bold text-gray-800 parent-hover-primary fs-5 mb-1">Foursquare
                                    Ads</span>
