        ...
        <form method="POST" action="{{ route('register') }}" class="form w-100" novalidate="novalidate">
            ...
            <div class="fv-row mb-8">
                <input id="name" name="name" :value="old('name')" required autocomplete="name" type="text"
                    placeholder="ادخل إسمك كاملاً" class="form-control bg-transparent" />
            </div>
            <div class="fv-row mb-8">
                <input id="email" name="email" :value="old('email')" required autocomplete="username"
                    type="text" placeholder="بريدك الإلكتروني" autocomplete="off"
                ...
                <div class="mb-1">
                    <div class="position-relative mb-3">
                        <input class="form-control bg-transparent" type="password" placeholder="كلمة المرور"
                            name="password" id="password" autocomplete="off" required autocomplete="new-password" />
            ...
            <div class="fv-row mb-8">
                <input placeholder="تأكيد كلمة المرور" name="confirm-password" type="password" autocomplete="off"
                    class="form-control bg-transparent" />
            </div>
            <div class="fv-row mb-8">
