                  ...
                  <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                      <div class="d-flex flex-column">
                          <div class="d-flex align-items-center mb-1">
                              <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bold me-3">Learning
                                  Paths Resorces</a>
                  ...
                  <div class="d-flex flex-wrap justify-content-start">
                      <div class="d-flex flex-wrap">
                          ...
                          <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                              ...
                              <div class="fw-semibold fs-6 text-gray-500">Project</div>
                          </div>
                          <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                              <div class="d-flex align-items-center">
                              ...
                              <div class="fw-semibold fs-6 text-gray-500">Quizzes</div>
                          </div>
                          <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                              <div class="d-flex align-items-center">
                                  <div class="fs-4 fw-bold counted" data-kt-countup="true" data-kt-countup-value="15000"
                              ...
                              <div class="fw-semibold fs-6 text-gray-500">Series</div>
                          </div>
                      </div>
          ...
          <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
              <li class="nav-item">
                  <a class="nav-link text-active-primary py-5 me-6 {{ request()->is('user/paths/visualize') ? 'active' : '' }}"
                      href="{{ route('user.path-visualize') }}">Overview</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link text-active-primary py-5 me-6 {{ request()->is('user/paths') ? 'active' : '' }}"
                      href="{{ route('user.path-view') }}">Resources</a>
              </li>
          </ul>
