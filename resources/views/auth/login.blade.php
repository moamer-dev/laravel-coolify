                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                            ...
                            <form method="POST" action="{{ route('login') }}" class="form w-100" novalidate="novalidate"
                                ...
                                <div class="separator separator-content my-14">
                                    <span class="w-125px text-gray-500 fw-semibold fs-7">Or with email/username</span>
                                </div>
                                <!--end::Separator-->
                                <!--begin::Input group=-->
                                <div class="fv-row mb-8">
                                    ...
                                    <input id="login" type="text" name="email" required autofocus
                                        placeholder="Email or Username" name="email" autocomplete="off"
                                ...
                                <div class="fv-row mb-3">
                                    ...
                                    <input id="password" type="password" name="password" required
                                        autocomplete="current-password" placeholder="Password" autocomplete="off"
